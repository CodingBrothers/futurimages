...
@Api(name = "futurimages", version = "v1", scopes = { Constants.PLUS_LOGIN_SCOPE, Constants.EMAIL_SCOPE }, clientIds = {
		Constants.FUTURIMAGES_WEB_CLIENT_ID, Constant.API_EXPLORER_CLIENT_ID })
