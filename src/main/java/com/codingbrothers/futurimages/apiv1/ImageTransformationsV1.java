...
public class ImageTransformationsV1 {
	...
	@ApiMethod(path = "images/{id}/transformations", httpMethod = HttpMethod.GET)
	...
	@ApiMethod(path = "images/{id}/transformations", httpMethod = HttpMethod.POST, authLevel = AuthLevel.REQUIRED)
